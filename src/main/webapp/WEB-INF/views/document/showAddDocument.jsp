	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				...
				<td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：文档管理  &gt; 上传文档</td>
			    ...
			    <td>
				 ...
				 <form id="documentForm" name="documentForm" action="${ctx }/document/addDocument" enctype="multipart/form-data" method="post">
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    ...
					    <tr><td class="font3 fftd">文档标题：<input type="text" name="title" size="30" id="title"/></td></tr>
