...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/ligerUI/js/core/base.js"></script>
    <script type="text/javascript" src="${ctx}/js/ligerUI/js/plugins/ligerDialog.js"></script>
    <script type="text/javascript" src="${ctx}/js/ligerUI/js/plugins/ligerDrag.js"></script>
    <script type="text/javascript" src="${ctx}/js/ligerUI/js/plugins/ligerResizable.js"></script>
...
<div class="page-lock">
    ...
    <div class="page-footer" style="color: #fff">
        <br><a href="http://www.szgxa.com/www/shenzhenguangxingan/" style="color: #fff">
        深圳市广信安科技股份有限公司</a> &nbsp; 版权所有
    </div>
</div>
